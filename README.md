...
`B10F_ONLY_GENRES` に置いた10件（SM / M男・金蹴り / 羞恥 / 乳首・おっぱい /
脚・足コキ / オナニー / CFNM / ギャル・ガン黒 / 手コキ / お尻・アナル）は、
**3社に同じ区分が無いので、ジャンルそのものを足している。** slug はこちらで決める。
ジャンル全体は 34 → 44 件。

**載せない区分がある。** 未成年を思わせるもの（女子校生・ロ◯ータ・ジュニアアイドル）、
同意のないもの（レ◯プ・盗◯・鬼畜）、近親相姦、排泄（放尿・スカトロ）。
B10F 自身が伏せ字にしている語もある。検索に載るページの題として出さない。

出演者名が入った作品が少ないタグはページにしても空になるので、
**2本以上出ている人が5人に満たないタグは飛ばす**（`MIN_RANKED`）。
